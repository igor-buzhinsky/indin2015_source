...
public class MachadoSFC__Composite {
    private final MachadoSFC instance = new MachadoSFC();
    ...
    /** FUNCTION_BLOCK MachadoSFC
     * @author JHC
     * @version 20150208/JHC
     */
    private class MachadoSFC extends FBInstance
    {
        ...
        public MachadoSFC() {
            ...
            X1 = (BOOL) SFC1.ovNamedNoException("X1");
            X2 = (BOOL) SFC1.ovNamedNoException("X2");
            X3 = (BOOL) SFC1.ovNamedNoException("X3");
            ...
            X30 = (BOOL) SFC4.ovNamedNoException("X30");
            X31 = (BOOL) SFC4.ovNamedNoException("X31");
            X32 = (BOOL) SFC4.ovNamedNoException("X32");
            X33 = (BOOL) SFC4.ovNamedNoException("X33");
            X34 = (BOOL) SFC4.ovNamedNoException("X34");
            X35 = (BOOL) SFC4.ovNamedNoException("X35");
            X36 = (BOOL) SFC4.ovNamedNoException("X36");
            X37 = (BOOL) SFC4.ovNamedNoException("X37");
            X38 = (BOOL) SFC4.ovNamedNoException("X38");
            vc_down = (BOOL) SFC4.ovNamedNoException("VCGD");
            X4 = (BOOL) SFC1.ovNamedNoException("X4");
            X11 = (BOOL) SFC2.ovNamedNoException("X11");
            X20 = (BOOL) SFC3.ovNamedNoException("X10");
            X21 = (BOOL) SFC3.ovNamedNoException("X11");
            X10 = (BOOL) SFC2.ovNamedNoException("X10");
