...
public class PnpXYCalculatorStep1__Basic {
    private final PnpXYCalculatorStep1 instance = new PnpXYCalculatorStep1();
    ...
    /** FUNCTION_BLOCK PnpXYCalculatorStep1
     * @author JHC
     * @version 20150208/JHC
     */
    private class PnpXYCalculatorStep1 extends FBInstance
    {
        /** VAR BASEX */
        ...
        private void state_INIT() {
            ...
            state_START();
            transition_PnpXYCalculatorStep1_0();
        }
        ...
        private void state_CLK() {
            ...
            state_START();
            transition_PnpXYCalculatorStep1_1();
        }

        /** The default constructor. */
        public PnpXYCalculatorStep1() {
            super();
        }
        ...
        public void service_INIT() {
            if ((eccState == index_START)) {
                state_INIT();
                transition_PnpXYCalculatorStep1_2(); 
            }
        }
        ...
        public void service_CLK() {
            if ((eccState == index_START)) {
                state_CLK();
                transition_PnpXYCalculatorStep1_3(); 
            }
        }
    ...
    private void transition_PnpXYCalculatorStep1_0() {
    }

    private void transition_PnpXYCalculatorStep1_1() {
    }

    private void transition_PnpXYCalculatorStep1_2() {
    }

    private void transition_PnpXYCalculatorStep1_3() {
    }
}