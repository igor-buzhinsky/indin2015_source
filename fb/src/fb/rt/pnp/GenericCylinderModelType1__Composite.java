...
public class GenericCylinderModelType1__Composite {
    private final GenericCylinderModelType1 instance = new GenericCylinderModelType1();

    public void event_INIT(int ForwardSpeed_, int BackwardSpeed_, boolean Extend_, boolean Retract_, int HomeSensorRange_0, int HomeSensorRange_1, int EndSensorRange_0, int EndSensorRange_1, float InitialPosition_, int LoadType_, int MovingtDistance_, boolean Loaded_, int MidSensorRange_0, int MidSensorRange_1) {
    ...
    public void event_CYL_IND(boolean Extend_, boolean Retract_) {
        instance.Extend.value = Extend_;
        instance.Retract.value = Retract_;
